...
public class BTreeTest {
    ...
    public void test4(String s, int nums[], int blockSize, int max) throws IOException {
        ...
        if  (s4a.size() == 0) System.out.println("No items found in range "+1+" "+max);
        else {
        ...
        if  (s4a.size() == 0) System.out.println("No items found in range "+max/8+" "+max/4);
        else {
            for (int j = 0; j < s4a.size(); j++) {
                s4 = s4a.get(j);
                System.out.println(s4.get(0)+" "+s4.get(1)+" "+s4.get(2)+" "+s4.get(3));
    ...
    public static void main(String args[]) throws IOException {
        ...
        System.out.print("Enter the maximum number of keys to use for tests 4a and 4b: ");
